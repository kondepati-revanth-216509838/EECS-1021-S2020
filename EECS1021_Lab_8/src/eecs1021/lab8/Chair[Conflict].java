...
/**
 * 
 * A class for simple chair. The Chair is a Furniture item
 * that has some fields (attributes). 
 * <strong>This class store the color, manufacturing cost and shape of a chair </strong>.
 * 
 * 
 *  <p> <strong> NOTE: In this class,  all string comparisons are carried 
 *  out with case insensitive </strong> </p>
 *
 */
...
public class Chair {
     ...
     * numChairs is a static variable that will be incremented each time 
     * a new Chair  object is 
	...
	/**
	 * Initializes this chair with color of the chair to <strong>WHITE</strong>
	 *  and chair shape to <strong>Rectangle</strong>.
	 * and initialize the chair initial manufacturing cost to zero dollar.
	 * 
	 * <p><strong>Notes: The numChairs field variable is incremented 
	 * each time a new chair object created </strong> </p>
	 */
	public Chair() {
	 ...
	 * 
	 * @throws IllegalArgumentException 
	 *  		<p>if the chair shape  is not one of possible chair shapes</p>.
	 * @throws IllegalArgumentException 
	 *  		<p>if the chair color is not one of possible chair colors</p>.
	 */
	...
	/**
	 * Get the string representation of the chair. 
	 * The string is  chair Shape, chair shape, chair initial cost .  
	 * 
