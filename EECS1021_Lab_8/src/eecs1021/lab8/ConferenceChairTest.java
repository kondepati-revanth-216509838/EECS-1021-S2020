...
public class ConferenceChairTest {
	...
	public void test00_00_CtrAAfull() {
		...
		argsnumberofWheels.add(4);
		argsCategory.add("Basic");
		argsnumberofWheels.add(6);
		argsCategory.add("Basic");
		argsnumberofWheels.add(8);
		...
		for (int i = 0; i < argsCategory.size(); i++) {
			...
			assertTrue("The  args constructor implemented wrongly ",
	...
	public void test01_00_ctor() {
		...
		assertEquals("no arg ctor did not set this.numberofWheels correctly", 4, cmch.getNumberofWheels());
	...
	public void test03c_ctor() {
		ConferenceChair cmch = new ConferenceChair(15.0, "sqquare", "green", "basic", 8);
	}
	...
	public void test04_00_calChairCostfull() {
		...
		for (int i = 0; i < argsCategory.size(); i++) {
			...
			objs.add(new ConferenceChair(15.0, "oval", argscolor.get(i), argsCategory.get(i),
					argsnumberofWheels.get(i)));
		}
