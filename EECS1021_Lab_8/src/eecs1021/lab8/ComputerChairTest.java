...
public class ComputerChairTest {
	...
	public void test03c_ctor() {
		ComputerChair cmch=new ComputerChair(120.0, "Square","black","basic",5);
	...
	public void test04_00_calChairCostfull() {
		...
		argsCategory.add("Normal");argsnumberofWheels.add(3);argscolor.add("brown"); argsPrice.add(135.0);
	...
	public void test06_00_calChairDeliveryCostfull() {
		...
		argsCategory.add("Normal");argsnumberofWheels.add(3);argscolor.add("orange"); argsPrice.add(130.0);
		argsCategory.add("Normal");argsnumberofWheels.add(5);argscolor.add("black");argsPrice.add(120.0);
		argsCategory.add("Normal");argsnumberofWheels.add(7);argscolor.add("red");argsPrice.add(130.0);
